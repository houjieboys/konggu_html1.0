...
var rename = require('gulp-rename');//修改文件名，例如将demo.css修改为demo.min.css，一般配合gulp-minify-css/gulp-uglify压缩插件一起使用
var header = require('gulp-header');//在压缩后的JS、CSS文件中添加头部注释
var sass = require('gulp-sass');//动态样式sass编译
var del = require('del');//删除文件和文件夹
var gulpif = require('gulp-if');//执行添加条件判断
var minimist = require('minimist');//
var zip = require('gulp-zip');//
var revCollector = require('gulp-rev-collector');//时间戳
